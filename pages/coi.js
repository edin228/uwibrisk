      ...
      <div className="flex flex-col w-full h-full">
        ...
        <div className="flex flex-col w-full h-full px-4 space-y-4 xl:space-y-0 xl:flex-row xl:flex-wrap xl:gap-8 xl:items-center xl:justify-center">
          <div className="flex flex-col gap-4">
            ...
            >
              <div className="flex flex-col items-center justify-center h-full p-2 text-center text-white rounded-xl black-gradient">
            ...
            <div className="flex items-center justify-center w-full h-[100px]">
              <a
                href={"https://clientportal.vertafore.com/Login/3004020-1"}
                className="flex items-center justify-center w-full h-full p-4 text-xl font-bold text-white rounded-lg shadow-lg black-gradient"
              >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-center w-full h-[100px]">
              <a
                ...
                className="relative flex items-center justify-center w-full h-full p-4 text-xl font-bold text-white rounded-lg shadow-lg black-gradient"
              >
