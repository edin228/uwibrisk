    ...
    <Base template={"Grid"}>
      ...
      <div className="flex flex-col w-full h-full">
        ...
        <div className="flex flex-col w-full h-full px-4 py-8 space-y-4 xl:py-20 xl:space-y-0 xl:flex-row xl:flex-wrap xl:gap-8 xl:items-center xl:justify-center">
          <a href={"/commercial-quote"} className="transition duration-100 hover:scale-105 cursor-pointer flex flex-col bg-white shadow-lg border-2 border-slate-100 rounded-xl h-[300px] xl:h-[500px] w-full xl:w-[237px] 2xl:w-[300px]">
          ...
          <a href={"/personal-quote"} className="transition duration-100 hover:scale-105 cursor-pointer flex flex-col bg-white shadow-lg border-2 border-slate-100 rounded-xl h-[300px] xl:h-[500px] w-full xl:w-[237px] 2xl:w-[300px]">
          ...
          <a href={"/benefits-quote"} className="transition duration-100 hover:scale-105 cursor-pointer flex flex-col bg-white shadow-lg border-2 border-slate-100 rounded-xl h-[300px] xl:h-[500px] w-full xl:w-[237px] 2xl:w-[300px]">
          ...
          <a href={"https://bxsurety.com/bx-pro-landing/92507"} target="_blank" className="transition duration-100 hover:scale-105 cursor-pointer flex flex-col bg-white shadow-lg border-2 border-slate-100 rounded-xl h-[300px] xl:h-[500px] w-full xl:w-[237px] 2xl:w-[300px]" rel="noreferrer">
