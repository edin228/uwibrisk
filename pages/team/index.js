      ...
      <div className="flex w-full flex-col py-2 px-2 space-y-4 lg:space-y-0 lg:gap-4 lg:py-4">
        ...
        <div className="flex flex-col w-full">
          <div className="flex flex-col w-full my-4">
            <div className="uppercase tracking-widest font-bold text-2xl py-2">
              Management
            </div>
            <div className="w-full h-[5px] blue-green-gradient rounded-lg" />
          </div>
          ...
          <div className="flex flex-col w-full my-4">
            ...
            <div className="w-full h-[5px] blue-purple-gradient rounded-lg" />
          </div>
          <div className="flex w-full flex-wrap space-y-2 md:space-y-0 md:gap-4">
            {data.teamMembers
          ...
          <div className="flex flex-col w-full my-4">
            ...
            <div className="w-full h-[5px] purple-gradient rounded-lg" />
          </div>
          <div className="flex w-full flex-wrap space-y-2 md:space-y-0 md:gap-4">
            {data.teamMembers
          ...
          <div className="flex flex-col w-full my-4">
            ...
            <div className="w-full h-[5px] blood-orange-gradient rounded-lg" />
          </div>
          <div className="flex w-full flex-wrap space-y-2 md:space-y-0 md:gap-4">
            {data.teamMembers
