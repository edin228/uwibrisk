...
function Base({ children, template = null, data = null, title=null }) {
  return (
    <div className="relative flex w-full h-full overflow-hidden text-color">
      <div className="absolute bottom-[20%] left-[0%] z-[-10] w-[600px] h-[100px] bg-yellow-500 skew-y-[-12deg] opacity-30 bg-accent-blur"></div>
      <div className="absolute bottom-[8%] left-[0%] z-[-10] w-[300px] h-[60px] bg-yellow-500 skew-y-[-12deg] opacity-30 bg-accent-blur"></div>
      <div className="absolute bottom-[16%] left-[0%] z-[-10] w-[400px] h-[20px] bg-black skew-y-[-12deg] opacity-30 bg-accent-blur"></div>
